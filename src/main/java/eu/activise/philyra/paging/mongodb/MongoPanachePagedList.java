package eu.activise.philyra.paging.mongodb;
...
public class MongoPanachePagedList<T> implements PagedList<T> {
  ...
  private MongoPanachePagedList(PanacheQuery<? extends T> query, int currentPage, int countPerPage, List<? extends T> list) {
    this.query = query;
